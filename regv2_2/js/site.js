...
function getBodyContent(){
    ...
    var arrElements = ['containerHeader','containerImage','containerImageArrow','containerForm','containerServiceTitle','containerServiceContent','containerLists','containerFooter'];
 ...
 $(document).ready(function(){
        ...
        var obj = ['#containerHeader','#containerImage','#containerImageArrow','#containerForm','#containerServiceTitle','#containerServiceContent','#containerLists','#containerFooter'];
        var borderWidth = '2px';
