...
function getBodyContent(){
    ...
    var arrElements = ['containerHL1','containerHL2','containerVideo','containerDateTime','containerForm','containerLeftTitle','containerAvatar','containerHostName','containerShareText','containerShareButtons','containerWarning','containerClaimSpot','containerClaimForms','containerFooter'];
 ...
 $(document).ready(function(){
        ...
        var obj = ['#containerHL1','#containerHL2','#containerVideo','#containerDateTime','#containerH3','#containerForm','#containerLeftTitle','#containerLists','#containerAvatar','#containerHostName','#containerShareText','#containerShareButtons','#containerWarning','#containerClaimSpot','#containerClaimForms','#containerFooter'];
        var borderWidth = '2px';
        ...
        function showLightBox(obj,btnName, ContentName){
           ...
           var htmlLightBox='';
            ...
            else if (btnName=="#containerClaimForms"){
                obj='';
...
//        }); 
        ...
        $(obj[9]).hover(function(){
                mouseOver(obj[9]);
        },function(){
                mouseOut(obj[9],"#img9");
        }); 
        
        $(obj[10]).hover(function(){
                mouseOver(obj[10]);
        },function(){
                mouseOut(obj[10],"#img10");
        }); 
        
        $(obj[11]).hover(function(){
                mouseOver(obj[11]);
        },function(){
                mouseOut(obj[11],"#img11");
        }); 
        
        $(obj[12]).hover(function(){
                mouseOver(obj[12]);
        },function(){
                mouseOut(obj[12],"#img12");
        }); 
        
//        $(obj[13]).hover(function(){
//                //mouseOver(obj[13]);
//        },function(){
//                mouseOut(obj[13],"#img13");
//        }); 
        
        $(obj[14]).hover(function(){
                mouseOver(obj[14]);
        },function(){
                mouseOut(obj[14],"#img14");
        }); 
        
        $(obj[15]).hover(function(){
                mouseOver(obj[15]);
        },function(){
                mouseOut(obj[15],"#img15");
        }); 
