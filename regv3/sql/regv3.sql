...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2014 at 08:51 AM
...
(3, 'containerVideo', '<p><img src="images/video.png" alt="" /></p>', 1),
(4, 'containerDateTime', '<p><span>Friday, June 25th,</span>11 AM Pacific Time</p>', 1),
(5, 'containerH3', '<h3>Enter your name and email now for instant access to your free report&hellip;</h3>', 1),
...
(17, 'containerFooter', '<p>Copyright 2014 - Company Name - All Rights Reserved</p>', 1);
...
(1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'images/no1.png', 1),
(2, 'Ut a ligula vitae ante vulputate consectetur quis eu urna.', 'images/no2.png', 1),
(3, 'Test List 1', 'thumbnails/temporary/20140708073047no1.png', 1);
