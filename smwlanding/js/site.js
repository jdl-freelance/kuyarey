 ...
 $(document).ready(function(){
        ...
        var obj = ['#containerHeader','#containerSubHeader','#containerEntryTitle','#containerLists','#containerWidgetTitle','#containerWidgetDescription','#containerForm','#containerBanner','#containerFooterLogo','#containerCompanyInfo','#containerCopyright'];
        var borderWidth = '2px';
...
function getBodyContent(){
    ...
    var arrElements = ['containerHeader','containerSubHeader','containerEntryTitle','containerLists','containerWidgetTitle','containerWidgetDescription','containerForm','containerBanner','containerFooterLogo','containerCompanyInfo','containerCopyright'];
