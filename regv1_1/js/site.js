 ...
 $(document).ready(function(){
        ...
        var obj = ['#containerHeader','#containerListsCaption','#containerLists','#containerVideo','#containerForms','#containerFormCaption','#containerFooter'];
        var borderWidth = '2px';
        ...
        function showLightBox(obj,btnName, ContentName){
           ...
           var htmlLightBox='';
            ...
            else if(btnName=="#containerForms"){
                obj='';
